      ...
      <div class="row align-items-end mb-4">
        <div class="col-lg-6">
          ...
          <h1 class="section-title mb-3">
            Visit Our Awesome Cleaning Projects
          </h1>
        </div>
        <div class="col-lg-6 text-center text-lg-right">
          <ul class="list-inline mb-2" id="portfolio-flters">
            ...
            <li class="btn btn-sm btn-outline-primary m-1" data-filter=".first">
              Complete
            </li>
            <li
            ...
            <li class="btn btn-sm btn-outline-primary m-1" data-filter=".third">
              Upcoming
            </li>
          </ul>
        </div>
